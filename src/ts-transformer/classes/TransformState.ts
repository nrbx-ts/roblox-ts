...
import luau, { RenderState, render, renderStatements, solveTempIds } from '@roblox-ts/luau-ast';
import type { PathTranslator } from '@roblox-ts/path-translator';
import { type RbxPath, RbxPathParent, RojoResolver } from '@roblox-ts/rojo-resolver';
...
import type { MultiTransformState } from 'ts-transformer';
import { DiagnosticService } from 'ts-transformer/classes/DiagnosticService';
import type { TransformServices, TryUses } from 'ts-transformer/types';
...
export class TransformState {
	...
	public readonly tryUsesStack = [] as TryUses[];
	...
	public readonly prereqStatementsStack = [] as luau.List<luau.Statement>[];
