...
} from 'ts-transformer/nodes/class/transformClassConstructor';
import { transformDecorators } from 'ts-transformer/nodes/class/transformDecorators';
import { transformPropertyDeclaration } from 'ts-transformer/nodes/class/transformPropertyDeclaration';
...
import { transformMethodDeclaration } from 'ts-transformer/nodes/transformMethodDeclaration';
...
export function transformClassLikeDeclaration(state: TransformState, node: ts.ClassLikeDeclaration) {
	...
	*/
	...
	const staticDeclarations: (ts.PropertyDeclaration | ts.ClassStaticBlockDeclaration)[] = [];
