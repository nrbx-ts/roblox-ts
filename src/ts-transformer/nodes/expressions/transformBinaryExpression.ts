...
import { transformLogical } from 'ts-transformer/nodes/transformLogical';
import { transformLogicalOrCoalescingAssignmentExpression } from 'ts-transformer/nodes/transformLogicalOrCoalescingAssignmentExpression';
...
} from 'ts-transformer/util/assignment';
import { createBitwiseFromOperator, isBitwiseOperator } from 'ts-transformer/util/bitwise';
