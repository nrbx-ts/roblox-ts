...
const addString: AddIterableToArrayBuilder = (_state, expression, arrayId, lengthId, amtElementsSinceUpdate) => {
	const result = luau.list.make<luau.Statement>();
...
const addSet: AddIterableToArrayBuilder = (_state, expression, arrayId, lengthId, amtElementsSinceUpdate) => {
	const result = luau.list.make<luau.Statement>();
...
const addMap: AddIterableToArrayBuilder = (_state, expression, arrayId, lengthId, amtElementsSinceUpdate) => {
	const result = luau.list.make<luau.Statement>();
...
const addGenerator: AddIterableToArrayBuilder = (_state, expression, arrayId, lengthId, amtElementsSinceUpdate) => {
	const result = luau.list.make<luau.Statement>();
